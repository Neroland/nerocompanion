...
All notable changes to **NeroCompanion** are documented in this file.
...
- **EMI support.** NeroCompanion adds no recipes of its own, so nothing needed a plugin. The build now
