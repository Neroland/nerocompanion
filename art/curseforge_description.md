...
- **Modpacks are allowed and encouraged** — any platform, no need to ask. Use the official files and credit *NeroCompanion by Neroland* with links to this page and the [GitHub repository](https://github.com/Neroland/nerocompanion). Full terms: [LICENSE](https://github.com/Neroland/nerocompanion/blob/main/LICENSE).
...
- 🟢 **[Also on Modrinth](https://modrinth.com/mod/nerocompanion)**
